  ...
  (lib_symbols
    (symbol "ESP32S3_MODULE" (pin_names (offset 1.016)) (in_bom yes) (on_board yes)
      ...
      (symbol "ESP32S3_MODULE_0_1"
        ...
        (pin output line (at -15.24 5.08 0) (length 5.08) (name "PWM_HEATER") (number "42"))
...
print("Generated KiCad schematic with perfect USB pad names and SAFE ESP32 pad (38,39,40,41,42) updates.")
