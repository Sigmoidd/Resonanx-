  ...
  (lib_symbols
    (symbol "ESP32S3_MODULE" (pin_names (offset 1.016)) (in_bom yes) (on_board yes)
      ...
      (symbol "ESP32S3_MODULE_0_1"
        ...
        (pin passive line (at -15.24 2.54 0) (length 5.08) (name "GPIO5") (number "2"))
        ...
        (pin passive line (at 15.24 5.08 180) (length 5.08) (name "GPIO17") (number "7"))
    ...
    (symbol "TP4056_IC" (pin_names (offset 1.016)) (in_bom yes) (on_board yes)
      ...
      (symbol "TP4056_IC_0_1"
        ...
        (pin passive line (at -10.16 2.54 0) (length 5.08) (name "VIN") (number "1"))
        (pin passive line (at -10.16 -2.54 0) (length 5.08) (name "BAT+") (number "2"))
        (pin passive line (at 10.16 2.54 180) (length 5.08) (name "BAT-") (number "3"))
        (pin passive line (at 10.16 -2.54 180) (length 5.08) (name "GND") (number "4"))
      )
    )
    ...
    (symbol "USBC_CONN" (pin_names (offset 1.016)) (in_bom yes) (on_board yes)
      ...
      (symbol "USBC_CONN_0_1"
        (rectangle (start -2.54 -2.54) (end 2.54 2.54) (stroke (width 0) (type default)) (fill (type background)))
        (pin passive line (at -7.62 2.54 0) (length 5.08) (name "VBUS") (number "1"))
        (pin passive line (at -7.62 -2.54 0) (length 5.08) (name "GND") (number "2"))
      )
    )
...
# PWR FLAGs - Using +2.54 to correctly hit the pin when Y is inverted in schematic!
...
print("Generated ERC-clean KiCad schematic perfectly.")
