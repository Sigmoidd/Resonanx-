...
footprints = {
    ...
    "J2": "Connector_FFC-FPC:TE_0-1734839-5_1x05-1MP_P0.5mm_Horizontal",
    "Q1": "Package_TO_SOT_SMD:SOT-23-3",
    "Q2": "Package_TO_SOT_SMD:SOT-23-3",
    "Q3": "Package_TO_SOT_SMD:SOT-23-3",
    "Q4": "Package_TO_SOT_SMD:SOT-23-3",
    "Q5": "Package_TO_SOT_SMD:SOT-23-3",
...
sch += f"""
  (text "POWER MANAGEMENT v1.12" (at 45.72 50.8 0) (effects (font (size 2 2)) (justify left)) (uuid "{u()}"))
...
print("Generated Clinical v1.12 Schematic with target footprints and Pin 23!")
