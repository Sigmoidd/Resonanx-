  ...
  (lib_symbols
    (symbol "ESP32S3_MODULE" (pin_names (offset 1.016)) (in_bom yes) (on_board yes)
      ...
      (symbol "ESP32S3_MODULE_0_1"
        ...
        (pin output line (at -15.24 5.08 0) (length 5.08) (name "GPIO4") (number "7"))
        (pin passive line (at -15.24 2.54 0) (length 5.08) (name "GPIO5") (number "8"))
        (pin output line (at -15.24 0 0) (length 5.08) (name "GPIO6") (number "9"))
        (pin output line (at -15.24 -2.54 0) (length 5.08) (name "GPIO7") (number "10"))
        (pin output line (at -15.24 -5.08 0) (length 5.08) (name "GPIO15") (number "18"))
        (pin output line (at -15.24 -7.62 0) (length 5.08) (name "GPIO16") (number "19"))
        (pin passive line (at 15.24 5.08 180) (length 5.08) (name "GPIO17") (number "20"))
    ...
    (symbol "USBC_CONN" (pin_names (offset 1.016)) (in_bom yes) (on_board yes)
      ...
      (symbol "USBC_CONN_0_1"
        (rectangle (start -2.54 -2.54) (end 2.54 2.54) (stroke (width 0) (type default)) (fill (type background)))
        (pin passive line (at -7.62 2.54 0) (length 5.08) (name "VBUS") (number "A4"))
        (pin passive line (at -7.62 2.54 0) (length 5.08) (name "VBUS") (number "B9"))
        (pin passive line (at -7.62 2.54 0) (length 5.08) (name "VBUS") (number "A9"))
        (pin passive line (at -7.62 2.54 0) (length 5.08) (name "VBUS") (number "B4"))
        (pin passive line (at -7.62 -2.54 0) (length 5.08) (name "GND") (number "A1"))
        (pin passive line (at -7.62 -2.54 0) (length 5.08) (name "GND") (number "B1"))
        (pin passive line (at -7.62 -2.54 0) (length 5.08) (name "GND") (number "A12"))
        (pin passive line (at -7.62 -2.54 0) (length 5.08) (name "GND") (number "B12"))
        (pin passive line (at -7.62 -2.54 0) (length 5.08) (name "SHIELD") (number "SH"))
      )
    )
...
add_label("NET_M_RNG_PNK", 172.72+7.62, 167.64-2.54, 0) # Merged net
...
# PWR FLAGs
add_label("VCC", 81.28, 55.88+2.54, 0)
...
print("Generated KiCad schematic with corrected pin mappings perfectly.")
