...
sch += f"""
  (text "POWER MANAGEMENT v1.6" (at 45.72 50.8 0) (effects (font (size 2 2)) (justify left)) (uuid "{u()}"))
...
print("Generated Clinical v1.6 Schematic with all upgrades!")
